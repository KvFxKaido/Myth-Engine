...
2. Begin with one or two tools:
   - [The Lens States](#lens-states)
   - [The Embodiment Protocol](#embodiment-protocol)
...
1. [The Prime Directive](#): Keep moving.
2. [Lens States](#): Understand how perception shifts.
3. [The Embodiment Protocol](#): Stay grounded through somatic presence.
4. The **Steward's Protocol** if you're navigating resets.
5. [Functional Equivalence](#): Work with systems that care.
